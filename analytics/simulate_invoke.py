...
if __name__ == '__main__':
    ...
    dict['messages'][0]['value'] = loadEventFromFile('../samples/task1.json')
    dict['ES_URL'] = 'https://admin:QZSFKVNUNTMWPHMY@portal-ssl65-41.bmix-dal-yp-c401ad96-667e-4128-af0e-cb3d54fd1cf9.250607799.composedb.com:62863/'
    dict['analytics-id'] = 'flux3'
    resp = task_summary.main(dict)
    print('first event respone=', resp)
    dict['messages'][0]['value'] = loadEventFromFile('../samples/task2.json')
    resp = task_summary.main(dict)
